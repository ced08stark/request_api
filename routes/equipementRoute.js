...
router.post('/equipements/materiels/user', equipementController.getAllEquipementMateriels)
router.post('/equipements/logiciels/user', equipementController.getAllEquipementLogiciels)
